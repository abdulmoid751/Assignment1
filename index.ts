...
function make_album(pArtistName : string ,pAlbumTitle: string )
{
    let album: { artistname: string, albumtitle: string } = {
...
let Album1 = make_album("artistname1", "albumtitle1");
let Album2 = make_album("artistname2", "albumtitle2");
let Album3 = make_album("artistname3", "albumtitle3");
